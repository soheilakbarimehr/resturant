      ...
      if (distance > deliverySettings.deliveryRadius) {
        setDeliveryError(
          `متأسفانه این آدرس خارج از محدوده ارسال ما است. حداکثر فاصله مجاز ${
            deliverySettings.deliveryRadius
          } کیلومتر می‌باشد. فاصله انتخاب شده: ${distance.toFixed(1)} کیلومتر`
        );
        setDeliveryFee(0);
        return;
      }
    ...
    return (
      <div className='container px-4 py-8 mx-auto md:py-16'>
        <div className='max-w-md mx-auto text-center'>
          ...
          <p className='mb-6 text-sm text-gray-600 md:text-base md:mb-8'>
            زمان تحویل تقریبی:{" "}
            <span className='font-bold'>{selectedOption.time}</span>
          </p>
          <Link
            to='/'
                    ...
                    option.enabled && (
                      ...
                      >
                        ...
                        <div className='flex items-start flex-1 gap-3 md:items-center md:gap-4'>
                          <div
                            className={`p-2 rounded-xl transition-colors md:p-3 ${
                              deliveryType === key
                          ...
                          <div className='flex-1'>
                            ...
                            <div className='flex flex-col gap-2 text-xs sm:flex-row sm:items-center sm:gap-3 md:text-sm md:gap-4'>
                              ...
                              <div
                                className={`font-semibold px-2 py-1 rounded-full w-fit md:px-3 ${
                                  option.fee === 0
              ...
              <div className='p-4 bg-white border border-gray-100 shadow-sm rounded-xl md:p-6'>
                ...
                {selectedLocation ? (
                  <div className='space-y-3 md:space-y-4'>
                    ...
                    >
                      <div className='flex items-start gap-2 md:gap-3'>
                        <MapPin
                          className={`w-4 h-4 mt-0.5 flex-shrink-0 md:w-5 md:h-5 ${
                        ...
                        <div className='flex-1'>
                          ...
                          <p
                            className={`mt-1.5 text-[10px] md:mt-2 md:text-xs ${
                              deliveryError ? "text-red-600" : "text-green-600"
                            }`}
                          >
                            📍 مختصات: {selectedLocation.lat.toFixed(6)},{" "}
                  ...
                  <div className='py-6 text-center md:py-8'>
                    ...
                    <h3 className='mb-2 text-base font-medium text-gray-900 md:text-lg'>
                      آدرس تحویل را انتخاب کنید
                    </h3>
                    <p className='mb-4 text-xs text-gray-600 md:text-sm md:mb-6'>
                      برای ادامه، آدرس تحویل سفارش را مشخص کنید
                    </p>
          ...
          <div className='space-y-4 md:space-y-6'>
            <div className='sticky p-4 bg-white border border-gray-100 shadow-sm rounded-xl top-4 md:p-6'>
              ...
              <div className='mb-4 space-y-2 md:mb-6 md:space-y-4'>
                ...
                <div className='flex justify-between text-xs md:text-sm'>
                  <span className='text-gray-600'>
                    هزینه {selectedOption.title}:
                  </span>
                  <span className='font-medium'>
                    {selectedOption.fee === 0
                      ? "رایگان"
                      : `${selectedOption.fee.toLocaleString("fa-IR")} تومان`}
                  </span>
                </div>
              ...
              <div className='flex items-center gap-2 p-3 mb-4 text-blue-700 border border-blue-200 bg-blue-50 rounded-xl md:gap-3 md:p-4 md:mb-6'>
                ...
                <div>
                  ...
                  <div className='text-[10px] md:text-xs'>
                    زمان تحویل: {selectedOption.time}
                  </div>
                </div>
              </div>
              ...
              <button
                ...
                disabled={
                  deliveryType === "delivery" &&
                  (!selectedLocation || deliveryError)
                }
          ...
          {selectedAddress && (
            <div className='p-3 mb-3 border border-green-200 bg-green-50 rounded-xl md:p-4 md:mb-4'>
              <div className='flex items-start gap-2 md:gap-3'>
                ...
                <div className='flex-1'>
                  <p className='mb-1 text-xs font-medium text-green-800 md:text-sm'>
                    آدرس انتخاب شده:
                  </p>
                  <p className='text-xs leading-relaxed text-green-700 md:text-sm'>
                    {selectedAddress}
                  </p>
                  {selectedPosition && (
                    <p className='mt-1.5 text-[10px] text-green-600 md:mt-2 md:text-xs'>
                      📍 مختصات: {selectedPosition[0].toFixed(6)},{" "}
